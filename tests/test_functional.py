"""Functional tests for detection engines and agents."""
...
def test_ioc_engine_detects_malicious_ip():
    """IoC engine should detect the test malicious IP."""
...
async def test_email_verification_agent():
    """Email agent should process the suspicious email."""
    ...
    assert result.status.value == "success", (
        f"EmailVerificationAgent failed: "
...
def test_agent_registry_registers_agents():
    ...
    registered_types = registry.list_agent_types()
